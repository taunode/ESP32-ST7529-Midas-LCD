...
// Wir erstellen eine eigene Klasse, die von Adafruit_GFX erbt
class MyCustomDisplay : public Adafruit_GFX {
  public:
    // Konstruktor: Übergib die Breite und Höhe deiner Matrix
    ...
    void drawPixel(int16_t x, int16_t y, uint16_t color) override {
      // Hier rufst du deine bestehende Funktion auf!
      // Adafruit-GFX nutzt meist 16-Bit Farben (RGB565).
      // Wenn dein Display Graustufen nutzt, musst du den Wert ggf. umrechnen.
      setPixel(x, y, 0); 
    }

    // Optional: Falls dein Display einen Buffer nutzt, kannst du hier
    // eine .display() oder .show() Methode hinzufügen.
};
...
String getFormattedTime() {
  ...
  // Wir nehmen die Millisekunden der aktuellen Sekunde (0-999) 
  // und teilen durch 100, um nur die erste Ziffer (0-9) zu erhalten.
