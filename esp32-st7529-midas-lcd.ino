/* ---------------------------------------------------------- */
// ESP32-Treiber für das ST7529-basierte MCCOG240160C6W-FPTLW //
// von Tim van den Boom, Studienarbeit im 6. Semester - 2026  //
/* ---------------------------------------------------------- */

// Wichtige Informationen zum Initialisierungsprozess des Midas-Displays stammen aus folgendem Github-Code:
// https://github.com/augustofg/libst7529

// Kommentare mit eckigen Klammern beziehen sich als Referenz auf die Seitenzahl im Datenblatt des ST7529
...
// Für das Schieberegister 595
const int PIN_SHIFT = 32;   // SRCLK
const int PIN_STORE = 33;   // RCLK
const int PIN_DATA  = 25;   // SER
...
void writeBus(uint8_t val) {
  ...
  */
  ...
  shiftOut(PIN_DATA, PIN_SHIFT, MSBFIRST, val);
...
/*
// Sende einen BEFEHL an den Display-IC -----------------------------------------------------------
*/
...
/*
// Sende einen DATENSATZ an den Display-IC --------------------------------------------------------
*/
...
void initDisplay() {
    ...
    // Kontrast
    writeCmd(0x81); // VOLCTRL (Befehl 23) DOPPELBYTE-BEFEEHL!
...
/*
// Setzten eines Pixels in den Framebuffer --------------------------------------------------------
*/
...
void updateDisplay() {
    ...
    // Das Display geht automatisch zum nächsten Pixel über, wenn es erkannt hat, dass ein gültiger Pixel gesendet wurde!
    ...
    // Hier werdne die Daten aus dem Framebuffer 3-Pixel-weise auf den Datenbus geschickt
...
// Initialisierung mit Display-Größe (Variablenübergabe an Adafruit_GFX)
MyCustomDisplay matrix(240, 160);

/*
// kleine Funktionen, um Text zu zentrieren / links / rechts darzustellen -------------------------
*/
...
/*
// Aufgepasst lieber Studienarbeits-Nachfolger!  --------------------------------------------------
//Hier habe ich Dir eine Beispielfunktion gebastelt, welche 
//über die Parameter der Funktion schon eine 
//Anzeige darstellt (gemäß Speedcoach 2)
*/
...
// Nebenfunktion, um die seit Systemstart verstrichene Zeit zu ermitteln --------------------------
...
void loop() {
  ...
  // gesamtes Display leeren - Wichtig, da Adafruit_GFX keine Pixel "löscht"!
